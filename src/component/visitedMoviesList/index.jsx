...
const VisitedMoviesList = () => {
  ...
  return (
    <div className=" ml-4 h-[300px] w-full rounded-md border border-gray-300 shadow-lg">
      {/* Header */}
      ...
      >
        {visitedMovies.map(movie => (
          <p
            className="flex h-auto items-center justify-center rounded-lg px-4 py-1 text-center  font-medium shadow-md transition-colors"
            key={movie}
            style={{
